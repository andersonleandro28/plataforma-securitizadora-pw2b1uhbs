...
//
//       -- Validação de Saldo: impede resgate superior ao saldo
...
//       END IF;
//
//       -- Retorno ao Estoque: deduz as cotas vendidas, tornando-as disponíveis novamente
//       UPDATE public.investment_products
...
//           END IF;
//
//           -- Registro de Evento (Log no Histórico da Série)
//           INSERT INTO public.audit_logs (entity_type, entity_id, action, user_id, details)
//           VALUES (
//               'debenture_series',
//               v_product.series_id,
