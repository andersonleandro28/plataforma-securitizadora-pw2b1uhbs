...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      credit_operations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'credit_operations_manager_id_fkey'
            columns: ['manager_id']
            isOneToOne: false
            referencedRelation: 'credit_managers'
            referencedColumns: ['id']
          },
        ]
      }
      ...
      movimentacoes_caixa: {
        ...
        Relationships: [
          {
            foreignKeyName: 'movimentacoes_caixa_bank_account_id_fkey'
            columns: ['bank_account_id']
            isOneToOne: false
            referencedRelation: 'company_bank_accounts'
            referencedColumns: ['id']
          ...
          {
            foreignKeyName: 'movimentacoes_caixa_transfer_counterpart_account_id_fkey'
      ...
      recebiveis_ccb: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'recebiveis_ccb_manager_id_fkey'
            columns: ['manager_id']
            isOneToOne: false
            referencedRelation: 'credit_managers'
            referencedColumns: ['id']
    ...
    Functions: {
      ...
      delete_cancelled_credit_operation: {
      ...
      extend_credit_operation_installment: {
        Args: {
          p_installment_idx: number
          p_interest_calculated?: number
          p_new_due_date: string
          p_operation_id: string
          p_penalty_calculated?: number
          p_reason?: string
        }
        Returns: Json
      }
      ...
      liquidate_credit_operation_installment:
        | {
            Args: {
              p_amount_paid: number
              p_installment_idx: number
              p_interest_applied?: number
              p_notes?: string
              p_operation_id: string
              p_payment_date: string
              p_penalty_applied?: number
            }
            Returns: Json
          }
        | {
      ...
      reject_investment: {
        Args: { p_investment_id: string; p_rejection_reason?: string }
        Returns: undefined
      }
      revert_ccb_installment_liquidation: {
        Args: { p_installment_idx: number; p_recebivel_id: string }
        Returns: Json
      }
      ...
      revert_credit_operation_installment_liquidation: {
        Args: { p_installment_idx: number; p_operation_id: string }
        Returns: Json
      }
      revert_redemption_payment: {
        Args: { p_reason?: string; p_redemption_id: string }
        Returns: Json
      }
      save_credit_operation_installments: {
        Args: { p_installments_data: Json; p_operation_id: string }
        Returns: Json
      }
