...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    let params = paramsData?.find((p: any) => p.receivable_type === opData.receivable_type) 
    ...
    const structuring_val = params.structuring_fee_type === 'fixed' ? structuring_fee : reqValue * (structuring_fee / 100)
